...
public class PedPurge : Script
{
    ...
    {
        WeaponHash[] weapons = { WeaponHash.Knife, WeaponHash.Pistol, WeaponHash.Bat, WeaponHash.MicroSMG, WeaponHash.AssaultRifle, WeaponHash.Crowbar, WeaponHash.DoubleBarrelShotgun, WeaponHash.CombatPistol, WeaponHash.Molotov, WeaponHash.SawnOffShotgun, WeaponHash.CarbineRifle, WeaponHash.PumpShotgun, WeaponHash.SniperRifle, WeaponHash.HeavyPistol, WeaponHash.MarksmanRifle, WeaponHash.MachinePistol, WeaponHash.Hatchet, WeaponHash.BattleAxe, WeaponHash.MiniSMG, WeaponHash.CombatMG, WeaponHash.RPG, WeaponHash.Grenade, WeaponHash.FlareGun, WeaponHash.HomingLauncher, WeaponHash.Machete, WeaponHash.Bottle, WeaponHash.PoolCue, WeaponHash.Wrench, WeaponHash.BZGas, WeaponHash.Firework, WeaponHash.SmokeGrenade, WeaponHash.StunGun };
